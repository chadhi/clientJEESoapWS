...
public class BanqueServiceServiceLocator extends org.apache.axis.client.Service implements ws.BanqueServiceService {
    ...
    public ws.BanqueWS getBanqueWSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.BanqueWSPortBindingStub _stub = new ws.BanqueWSPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.BanqueWS.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.BanqueWSPortBindingStub _stub = new ws.BanqueWSPortBindingStub(new java.net.URL(BanqueWSPort_address), this);
                _stub.setPortName(getBanqueWSPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws/", "BanqueServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws/", "BanqueWSPort"));
        }
